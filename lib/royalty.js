...
const PHANTOM_ORIGIN = {
  ...
  marketplace: "https://phantomcapital.live",
...
export function royaltyHeaders(req, res, next) {
  ...
  res.setHeader(
    ...
    "sol:HmW2bQeLpJv3FJrSBV1jeyra2oof5rq6uBkB1cSLnSAK | eth:0xeBa3d756E948232Ee18FAAE58583c5D5D90D1117"
  );
...
export function phantomManifest(req, res) {
  ...
  res.json({
    ...
    deployment: {
      host,
      platform,
      isOriginal: host.includes("phantomcapital.live"),
      isFork: !host.includes("phantomcapital.live"),
    ...
    paymentInstructions: {
      solana: {
        address: "HmW2bQeLpJv3FJrSBV1jeyra2oof5rq6uBkB1cSLnSAK",
